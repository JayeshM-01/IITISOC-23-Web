...
<h1 className="bookheading">How to book appoinment</h1>
  <div className="step">
      <div className="steps">
        ...
        <img src="https://img.freepik.com/free-vector/group-therapy-illustration-concept_52683-45774.jpg?w=2000" className="imgstep1"></img>
      </div>

      <div className="steps" id="step-2para">
      <img src="https://media.istockphoto.com/id/1219529898/vector/businessman-choose-a-date-on-a-calendar.jpg?s=1024x1024&w=is&k=20&c=6uMTD1eb9mWLoJuShUDWNHUdqgVHFUPjhjvPEffd3Xs=" className="imgstep1"></img>
      ...
      <div className="steps">
        ...
        <img src="https://media.istockphoto.com/id/1168750663/photo/checklist.webp?b=1&s=170667a&w=0&k=20&c=uzd6joHbEZpQwvr_xyFSngpAo0wm6weL5D2pgSZZ_nk=" className="imgstep3">
        </img>
      </div>
  </div>
  </div>
